...
public class UserDetailActivity extends AppCompatActivity {
    ...
    private static final String FETCH_URL= "http://testlife.cloudapp.net/AutService.asmx/GetUserDetails"; //azure
    //private static final String FETCH_URL= "http://10.233.204.232:9090/AutService.asmx/GetUserDetails"; //internal
    private static final String SAVE_URL = "http://testlife.cloudapp.net/AutService.asmx/SaveUserDetails"; // azure
